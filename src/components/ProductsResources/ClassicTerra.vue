  ...
  <div class="main">
    <div class="detailed-main">
      ...
      <div class="main-information" data-aos="fade-right">
        <div class="slogan">
          <h1>The Elegance of Classic</h1>
        </div>
        <div class="text">
          <p>
            Classic represents a timeless and elegant approach to sustainable
            living, drawing inspiration from the wisdom of the past to create a
            harmonious and enduring lifestyle. By blending heritage with
            adaptability, individuals can embark on a journey that not only
            respects the environment but also honors the cultural richness of
            the past.
          </p>
        </div>
        <router-link to="/main/minimal"
          ><base-button class="main-button"> Minimal </base-button></router-link
        >
      </div>
    </div>
  </div>
...
import img1 from "../../assets/classic/classic1.webp";
import img2 from "../../assets/classic/classic2.webp";
import img3 from "../../assets/classic/classic3.webp";
import img4 from "../../assets/classic/classic4.webp";
