  ...
  <div class="main">
    <div class="detailed-main">
      ...
      <div class="main-information" data-aos="fade-right">
        <div class="slogan">
          <h1>Sustainable Living in the 21st Century</h1>
        </div>
        <div class="text">
          <p>
            Modern represents a holistic and forward-thinking lifestyle that
            seeks to create a symbiotic relationship between individuals and the
            planet. By embracing these principles, individuals can contribute to
            a healthier environment while enjoying a high quality of life.
          </p>
        </div>
        <router-link to="/main/classic"
          ><base-button class="main-button"> Classic </base-button></router-link
        >
      </div>
    </div>
  </div>
...
import img1 from "../../assets/modernTerra/modern1.avif";
import img2 from "../../assets/modernTerra/modern2.avif";
import img3 from "../../assets/modernTerra/modern3.avif";
import img4 from "../../assets/modernTerra/modern4.avif";
